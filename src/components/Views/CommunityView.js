...
const CommunityView = ({ navigation }) => {
  const points = [{lat: 60.278168, lng: 24.596941, icon:'location3.png', text: 'Muinaisluola'}, {lat: 60.275972, lng:24.597269, icon:'location3.png',text: 'Hieno kivi'}, {lat:60.277539, lng:24.602004, icon:'location3.png', text:'Hieno kuusi'}]
  const posts = [
    ...
    {title: 'Cool rock formation', location: 'Nuuksio, 5km', text:'A big rock.', poster: {img: 'https://source.unsplash.com/512x512/?face,'+Math.random(), name: 'Laura W.'}},
  ...
  return (
    <Page>
      <Map points={points} hidePoints customzoom={15} />
